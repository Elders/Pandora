...
namespace Elders.Pandora
{
    public class PandoraOptions
    {
        ...
        public static PandoraOptions Defaults = new PandoraOptions() { ClusterName = "local", MachineName = Environment.GetEnvironmentVariable("COMPUTERNAME"), UseRawSettingsNames = false };
    }
}
